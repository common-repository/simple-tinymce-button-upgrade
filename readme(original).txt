...
<a href="http://www.youtube.com/watch?v=7thuFbZWniE">Screencast 1</a> - You can view my screencast showing the plugin in action; and detailing some of the functionality.
...
You can click <a target="_blank" href="http://wordpress.org/tags/simple-tinymce-button-upgrade?forum_id=10">HERE</a> to create a thread in the WordPress forum, which will autotag with the plugin name for a faster response.

NOTE:  Since releasing this plugin, I have found that including all 291 Google fonts can cause an increase in the page load time.  While I am working on resolving this, please see my other plugin <a href="http://wordpress.org/extend/plugins/ultimate-tinymce/">HERE</a>.  This plugin is exactly the same, but without the 291 Google Webfonts.  If the increase in page load time is significantly noticable; this plugin will work in the mean time.
